...
// RUN: env SYCL_CACHE_ENABLE_PERSISTENT=1 %CPU_RUN_PLACEHOLDER %t.out
// RUN: env SYCL_CACHE_ENABLE_PERSISTENT=1 %GPU_RUN_PLACEHOLDER %t.out
// RUN: env SYCL_CACHE_ENABLE_PERSISTENT=1 %ACC_RUN_PLACEHOLDER %t.out
// XFAIL: cuda
#include <CL/sycl.hpp>
